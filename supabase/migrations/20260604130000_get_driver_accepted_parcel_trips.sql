-- Liste fiable des transports colis acceptés pour l'onglet "Mes courses" transporteur
-- (contourne les limitations RLS sur parcel_quote_requests lors des jointures PostgREST)
...
-- Renforcer la politique SELECT si la migration précédente n'a pas été appliquée
