      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-8 leading-relaxed">
            ...
            Vous pouvez maintenant réserver des courses avec nos chauffeurs professionnels.
          </p>
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex-1 p-8 lg:p-12">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 text-lg">
                Rejoignez notre plateforme pour réserver vos courses
              </p>
            </div>
          ...
          <div className="lg:w-96 bg-purple-600 p-8 lg:p-12 text-white">
            ...
            <div className="mt-12 p-6 bg-purple-700 rounded-xl">
              <h3 className="font-semibold text-lg mb-2">Réservez maintenant</h3>
              <p className="text-purple-200 text-sm">
                Créez votre compte en quelques minutes et commencez à réserver 
                vos courses avec nos chauffeurs professionnels.
              </p>
            </div>
          </div>
        </div>
