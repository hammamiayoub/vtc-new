...
import { User, Mail, Lock, Eye, EyeOff, ArrowLeft, CheckCircle, Phone, Car } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-8 leading-relaxed">
            Votre compte client a été créé. Vous pouvez maintenant réserver 
            des courses avec nos chauffeurs professionnels.
          </p>
          ...
          <div className="flex-1 p-8 lg:p-12">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 text-lg">
                Rejoignez DriveConnect pour réserver vos courses
              </p>
            </div>
          ...
          <div className="lg:w-96 bg-purple-600 p-8 lg:p-12 text-white">
            ...
            <div className="mt-12 p-6 bg-purple-700 rounded-xl">
              ...
              <p className="text-purple-200 text-sm">
                ...
                course avec nos chauffeurs de confiance.
              </p>
            </div>
          </div>
        </div>
